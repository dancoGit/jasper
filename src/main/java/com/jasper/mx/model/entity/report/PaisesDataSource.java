package com.jasper.mx.model.entity.report;
...
public class PaisesDataSource implements JRDataSource{
    ...
    public PaisesDataSource(List<Main> data){
        ...
        listadoPaises = new Object[][]{
                                        ...
                                        {50, String.valueOf(data.get(0).getId()), data.get(0).getName(), data.get(0).getAge()},
                                        {51, String.valueOf(data.get(1).getId()), data.get(1).getName(), data.get(1).getAge()},
                                        {52, String.valueOf(data.get(2).getId()), data.get(2).getName(), data.get(2).getAge()}
                                      };
    }
    ...
    public static JRDataSource getDataSource(List<Main> data){
        return new PaisesDataSource(data);
    }
}